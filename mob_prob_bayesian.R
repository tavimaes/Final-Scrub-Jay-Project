...
#to observe mobbing using Bayesian models
...
saveRDS(m_mob_v1, "models/m_mob_v1.rds")
...
saveRDS(m_mob_v2, "models/m_mob_v2.rds")
...
saveRDS(m_mob_final, "models/m_mob_final.rds")
...
#coef plot for mob
ggplot(mob_coefs, aes(x = estimate, y = reorder(term, estimate))) +
  geom_point(size = 2) +
  ...
  labs(
    ...
    y = "Predictor",
    title = "Effects on Mob Probability"
  )
